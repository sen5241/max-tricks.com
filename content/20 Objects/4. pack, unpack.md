...
Start by creating a new patcher window, then adding five integer number boxes. Then add a `pack` object with five zeroes as **arguments**. This will create a `pack 0 0 0 0 0` object with five inlets. Connect the five number boxes to the `pack 0 0 0 0 0` object, and connect the `pack 0 0 0 0 0` outlet to a `print` object. Your patch should look like this:
